# -*- coding: utf-8 -*-
import pandas as pd
import os, csv, io, codecs, pythoncom, win32com.client
...
template_dir = os.path.dirname(os.path.abspath(__file__)) + '/static/output/template/'
...
#                break
        ...
        with codecs.open(input_path, "r", "utf-16", "ignore") as file:
...
#       sheet = workbook.Sheets('Sheet1').Select(); 
        sheet.Activate()
        sheet.Cells(3,1).Value="購買部"
        sheet.Cells(16,1).Value="仕入先"
        sheet.Cells(29,1).Value="経理部"
        
        

        
        shape1 = sheet.Shapes.AddShape(18,sheet.cells(1,2).Left, sheet.cells(8,1).Top, 40, 40)
        shape1.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape1.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape2 = sheet.Shapes.AddShape(18,sheet.cells(1,3).Left, sheet.cells(23,1).Top, 40, 40)
        shape2.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape2.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        #Ⓕの書き方
        shape3 = sheet.Shapes.AddShape(73,sheet.cells(1,4).Left, sheet.cells(23,1).Top, 40, 40)
        ...
        shape3.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape4 = sheet.Shapes.AddShape(73,sheet.cells(1,5).Left, sheet.cells(23,1).Top, 40, 40)
        ...
        shape4.TextFrame2.TextRange.Characters.Font.Size = 18
        
        #〶の書き方
        shape5 = sheet.Shapes.AddShape(73,sheet.cells(1,6).Left, sheet.cells(23,1).Top, 40, 40)
        ...
        shape5.TextFrame2.TextRange.Characters.Font.Size = 14
        
        #△の書き方
        shape6 = sheet.Shapes.AddShape(81,sheet.cells(1,7).Left, sheet.cells(9,1).Top, 40, 40)
        shape6.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape6.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape7 = sheet.Shapes.AddShape(4,sheet.cells(1,8).Left, sheet.cells(9,1).Top, 40, 40)
        shape7.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape7.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape8 = sheet.Shapes.AddShape(73,sheet.cells(1,9).Left, sheet.cells(7,1).Top, 40, 40)
        ...
        shape8.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape9 = sheet.Shapes.AddShape(73,sheet.cells(1,10).Left, sheet.cells(7,1).Top, 40, 40)
        ...
        shape9.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape10 =sheet.Shapes.AddShape(77,sheet.cells(1,11).Left, sheet.cells(9,1).Top, 40, 40)
        shape10.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape10.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape11 = sheet.Shapes.AddShape(77,sheet.cells(1,11).Left, sheet.cells(7,1).Top, 40, 40)
        shape11.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape11.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape12 = sheet.Shapes.AddShape(73,sheet.cells(1,11).Left, sheet.cells(6,1).Top, 40, 40)
        ...
        shape12.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape13 = sheet.Shapes.AddShape(73,sheet.cells(1,12).Left, sheet.cells(6,1).Top, 40, 40)
        ...
        shape13.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape14 = sheet.Shapes.AddShape(73,sheet.cells(1,13).Left, sheet.cells(5,1).Top, 40, 40)
        ...
        shape14.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape15 = sheet.Shapes.AddShape(73,sheet.cells(1,14).Left, sheet.cells(5,1).Top, 40, 40)
        ...
        shape15.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape16 = sheet.Shapes.AddShape(73,sheet.cells(1,15).Left, sheet.cells(4,1).Top, 40, 40)
        ...
        shape16.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape17 = sheet.Shapes.AddShape(82,sheet.cells(1,15).Left, sheet.cells(6,1).Top, 40, 40)
        shape17.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape17.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape18 = sheet.Shapes.AddShape(73,sheet.cells(1,16).Left, sheet.cells(5,1).Top, 40, 40)
        ...
        shape18.TextFrame2.TextRange.Characters.Font.Size = 14
        
        shape19 = sheet.Shapes.AddShape(81,sheet.cells(1,17).Left, sheet.cells(23,1).Top, 40, 40)
        shape19.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape19.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape20 = sheet.Shapes.AddShape(81,sheet.cells(1,17).Left, sheet.cells(4,1).Top, 40, 40)
        shape20.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape20.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape21 = sheet.Shapes.AddShape(82,sheet.cells(1,19).Left, sheet.cells(4,1).Top, 40, 40)
        shape21.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape21.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape22 = sheet.Shapes.AddShape(73,sheet.cells(1,18).Left, sheet.cells(22,1).Top, 40, 40)
        ...
        shape22.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape23 = sheet.Shapes.AddShape(73,sheet.cells(1,19).Left, sheet.cells(22,1).Top, 40, 40)
        ...
        shape23.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape24 = sheet.Shapes.AddShape(73,sheet.cells(1,19).Left, sheet.cells(23,1).Top, 40, 40)
        ...
        shape24.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape25 = sheet.Shapes.AddShape(1,sheet.cells(1,19).Left, sheet.cells(20,1).Top, 40, 40)
        shape25.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape25.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape26 = sheet.Shapes.AddShape(73,sheet.cells(1,20).Left, sheet.cells(20,1).Top, 40, 40)
        ...
        shape26.TextFrame2.TextRange.Characters.Font.Size = 14
        
        shape27 =sheet.Shapes.AddShape(73,sheet.cells(1,20).Left, sheet.cells(22,1).Top, 40, 40)
        ...
        shape27.TextFrame2.TextRange.Characters.Font.Size = 14
        
        shape28 = sheet.Shapes.AddShape(81,sheet.cells(1,21).Left, sheet.cells(12,1).Top, 40, 40)
        shape28.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape28.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape29 = sheet.Shapes.AddShape(82,sheet.cells(1,22).Left, sheet.cells(13,1).Top, 40, 40)
        shape29.Fill.ForeColor.RGB = rgbToInt((0,0,0))
        shape29.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape30 = sheet.Shapes.AddShape(4,sheet.cells(1,23).Left, sheet.cells(13,1).Top, 40, 40)
        shape30.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape30.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape31 = sheet.Shapes.AddShape(4,sheet.cells(1,22).Left, sheet.cells(12,1).Top, 40, 40)
        shape31.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape31.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape32 = sheet.Shapes.AddShape(4,sheet.cells(1,20).Left, sheet.cells(11,1).Top, 40, 40)
        shape32.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape32.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape33 = sheet.Shapes.AddShape(73,sheet.cells(1,23).Left, sheet.cells(12,1).Top, 40, 40)
        ...
        shape33.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape34 = sheet.Shapes.AddShape(82,sheet.cells(1,25).Left, sheet.cells(13,1).Top, 40, 40)
        shape34.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape34.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape35 = sheet.Shapes.AddShape(82,sheet.cells(1,25).Left, sheet.cells(14,1).Top, 40, 40)
        shape35.Fill.ForeColor.RGB = rgbToInt((0,0,0))
        shape35.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape36 =sheet.Shapes.AddShape(77,sheet.cells(1,26).Left, sheet.cells(14,1).Top, 40, 40)
        shape36.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape36.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape37 =sheet.Shapes.AddShape(77,sheet.cells(1,26).Left, sheet.cells(12,1).Top, 40, 40)
        shape37.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape37.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape38 = sheet.Shapes.AddShape(73,sheet.cells(1,26).Left, sheet.cells(10,1).Top, 40, 40)
        ...
        shape38.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape39 = sheet.Shapes.AddShape(73,sheet.cells(1,27).Left, sheet.cells(10,1).Top, 40, 40)
        ...
        shape39.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape40 = sheet.Shapes.AddShape(81,sheet.cells(1,27).Left, sheet.cells(37,1).Top, 40, 40)
        shape40.Fill.ForeColor.RGB = rgbToInt((255,255,255))
        shape40.Line.ForeColor.RGB = rgbToInt((0,0,0))
        
        shape41 = sheet.Shapes.AddShape(73,sheet.cells(1,28).Left, sheet.cells(35,1).Top, 40, 40)
        ...
        shape41.TextFrame2.TextRange.Characters.Font.Size = 12
        
        shape42 = sheet.Shapes.AddShape(73,sheet.cells(1,29).Left, sheet.cells(35,1).Top, 40, 40)
        ...
        shape42.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape43 = sheet.Shapes.AddShape(73,sheet.cells(1,32).Left, sheet.cells(35,1).Top, 40, 40)
        ...
        shape43.TextFrame2.TextRange.Characters.Font.Size = 12
        
        shape44 = sheet.Shapes.AddShape(73,sheet.cells(1,33).Left, sheet.cells(35,1).Top, 40, 40)
        ...
        shape44.TextFrame2.TextRange.Characters.Font.Size = 18
        
        shape45 = sheet.Shapes.AddShape(82,sheet.cells(1,33).Left, sheet.cells(37,1).Top, 40, 40)
